...
export default function BasicTabs() {
    ...
    const handleInputUnitChange = (event, value) => {
        if (value) {
            setEmployeeData({...employeeData, unit_id: value.id});
        } else {
            setEmployeeData({...employeeData, unit_id: null});
        }
    };
                ...
                <form>
                    ...
                    <Box marginBottom={2}>
                        <Autocomplete
                            ...
                            value={units.find((unit) => unit.id === employeeData.unit_id) || ''}
